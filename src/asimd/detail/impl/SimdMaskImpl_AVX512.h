...
SIMD_MASK_IMPL_REG_BITS_UNSPLITABLE( AVX512,  2, __mmask8  )
SIMD_MASK_IMPL_REG_BITS_UNSPLITABLE( AVX512,  4, __mmask8  )
...
SIMD_MASK_IMPL_REG_REDUCTION( AVX512,  2, 1, all, ( mask.data.reg & 0x3 ) == 0x3 )
SIMD_MASK_IMPL_REG_REDUCTION( AVX512,  4, 1, all, ( mask.data.reg & 0xf ) == 0xf )
SIMD_MASK_IMPL_REG_REDUCTION( AVX512,  8, 1, all, __mmask8 ( ~mask.data.reg ) == 0 )
SIMD_MASK_IMPL_REG_REDUCTION( AVX512, 16, 1, all, __mmask16( ~mask.data.reg ) == 0 )
SIMD_MASK_IMPL_REG_REDUCTION( AVX512, 32, 1, all, __mmask32( ~mask.data.reg ) == 0 )
SIMD_MASK_IMPL_REG_REDUCTION( AVX512, 64, 1, all, __mmask64( ~mask.data.reg ) == 0 )

SIMD_MASK_IMPL_REG_REDUCTION( AVX512,  2, 1, any, ( mask.data.reg & 0x3 ) != 0 )
SIMD_MASK_IMPL_REG_REDUCTION( AVX512,  4, 1, any, ( mask.data.reg & 0xf ) != 0 )

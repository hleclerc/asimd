...
SIMD_MASK_IMPL_REG_REDUCTION( AVX, 4, 64, all, _mm256_testc_si256( mask.data.reg, _mm256_set1_epi32( -1 ) ) != 0 )
SIMD_MASK_IMPL_REG_REDUCTION( AVX, 8, 32, all, _mm256_testc_si256( mask.data.reg, _mm256_set1_epi32( -1 ) ) != 0 )

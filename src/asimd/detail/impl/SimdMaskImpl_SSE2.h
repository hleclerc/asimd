...
// Below SSE4.1 the generic reductions in SimdMaskImpl_Generic.h take over.
#ifdef ASIMD_X86_HAS_SSE4_1
SIMD_MASK_IMPL_REG_REDUCTION( SSE4_1, 2, 64, all, _mm_testc_si128( mask.data.reg, _mm_set1_epi32( -1 ) ) != 0 )
SIMD_MASK_IMPL_REG_REDUCTION( SSE4_1, 4, 32, all, _mm_testc_si128( mask.data.reg, _mm_set1_epi32( -1 ) ) != 0 )

SIMD_MASK_IMPL_REG_REDUCTION( SSE4_1, 2, 64, any, _mm_testz_si128( mask.data.reg, _mm_set1_epi32( -1 ) ) == 0 )
SIMD_MASK_IMPL_REG_REDUCTION( SSE4_1, 4, 32, any, _mm_testz_si128( mask.data.reg, _mm_set1_epi32( -1 ) ) == 0 )
#endif
